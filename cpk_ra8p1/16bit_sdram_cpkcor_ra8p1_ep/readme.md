...
#### 工程概述:
* 该示例工程演示了基于CPKCOR-RA8P1开发板的16位SDRAM驱动及读写速率的测试。
...
#### 硬件连接：
* 通过 USB Type-C 线连接调试主机和 CPKCOR-RA8P1板上的 USB 调试端口。
![alt text](images/ra8p1_cor_cpk.jpg)
...
[sdram_16bit_cpkcor_ra8p1_ep](sdram_16bit_cpkcor_ra8p1_ep.md)
