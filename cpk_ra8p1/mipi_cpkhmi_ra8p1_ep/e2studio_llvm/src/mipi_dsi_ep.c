...
static fsp_err_t mipi_dsi_set_display_time (void);
...
timer_info_t timer_info         = { .clock_frequency = RESET_VALUE, .count_direction = RESET_VALUE,\
...
{2,  {0xE1,0x93},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0xE2,0x65},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0xE3,0xF8},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x80,0x03},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},


{2,  {0xE0,0x01},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x00,0x00},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x01,0x3B},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},

{2,  {0x0C,0x74},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},

{2,  {0x17,0x00},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x18,0xAF},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x19,0x00},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x1A,0x00},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x1B,0xAF},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x1C,0x00},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},


{2,  {0x35,0x26},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},

{2,  {0x37,0x09},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},

{2,  {0x38,0x04},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x39,0x00},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x3A,0x01},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x3C,0x78},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x3D,0xFF},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x3E,0xFF},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x3F,0x7F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},

{2,  {0x40,0x06},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x41,0xA0},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x42,0x81},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x43,0x1E},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},//VFP=30
{2,  {0x44,0x0B},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x45,0x28},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},

{2,  {0x55,0x02},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x57,0x69},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x59,0x0A},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x5A,0x2A},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x5B,0x17},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},

{2,  {0x5D,0x7F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x5E,0x6B},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x5F,0x5C},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x60,0x4F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x61,0x4D},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x62,0x3F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x63,0x42},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x64,0x2B},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x65,0x44},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x66,0x43},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x67,0x43},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x68,0x63},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x69,0x52},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x6A,0x5A},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x6B,0x4F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x6C,0x4E},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x6D,0x20},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x6E,0x0F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x6F,0x00},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},

{2,  {0x70,0x7F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x71,0x6B},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x72,0x5C},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x73,0x4F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x74,0x4D},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x75,0x3F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x76,0x42},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x77,0x2B},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x78,0x44},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x79,0x43},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x7A,0x43},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x7B,0x63},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x7C,0x52},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x7D,0x5A},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x7E,0x4F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x7F,0x4E},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x80,0x20},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x81,0x0F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x82,0x00},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},



{2,  {0xE0,0x02},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x00,0x42},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x01,0x42},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x02,0x40},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x03,0x40},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x04,0x5E},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x05,0x5E},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x06,0x5F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x07,0x5F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x08,0x5F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x09,0x57},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x0A,0x57},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x0B,0x77},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x0C,0x77},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x0D,0x47},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x0E,0x47},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x0F,0x45},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x10,0x45},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x11,0x4B},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x12,0x4B},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x13,0x49},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x14,0x49},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x15,0x5F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},

{2,  {0x16,0x41},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x17,0x41},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x18,0x40},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x19,0x40},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x1A,0x5E},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x1B,0x5E},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x1C,0x5F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x1D,0x5F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x1E,0x5F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x1F,0x57},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x20,0x57},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x21,0x77},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x22,0x77},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x23,0x46},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x24,0x46},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x25,0x44},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x26,0x44},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x27,0x4A},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x28,0x4A},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x29,0x48},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x2A,0x48},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x2B,0x5F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},

{2,  {0x2C,0x01},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x2D,0x01},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x2E,0x00},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x2F,0x00},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x30,0x1F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x31,0x1F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x32,0x1E},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x33,0x1E},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x34,0x1F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x35,0x17},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x36,0x17},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x37,0x37},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x38,0x37},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x39,0x08},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x3A,0x08},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x3B,0x0A},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x3C,0x0A},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x3D,0x04},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x3E,0x04},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x3F,0x06},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x40,0x06},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x41,0x1F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},

{2,  {0x42,0x02},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x43,0x02},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x44,0x00},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x45,0x00},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x46,0x1F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x47,0x1F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x48,0x1E},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x49,0x1E},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x4A,0x1F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x4B,0x17},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x4C,0x17},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x4D,0x37},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x4E,0x37},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x4F,0x09},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x50,0x09},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x51,0x0B},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x52,0x0B},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x53,0x05},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x54,0x05},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x55,0x07},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x56,0x07},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x57,0x1F},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},

{2,  {0x58,0x40},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x5B,0x30},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x5C,0x00},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x5D,0x34},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x5E,0x05},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x5F,0x02},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x63,0x00},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x64,0x6A},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x67,0x73},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x68,0x05},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x69,0x08},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x6A,0x6A},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x6B,0x08},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},

{2,  {0x6C,0x00},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x6D,0x00},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x6E,0x00},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x6F,0x88},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},

{2,  {0x75,0xFF},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x77,0xDD},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x78,0x2A},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x79,0x15},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x7A,0x17},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x7D,0x14},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x7E,0x82},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},


{2,  {0xE0,0x04},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x00,0x0E},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x02,0xB3},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x09,0x61},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x0E,0x48},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},

{2,  {0xE0,0x00},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0x80,0x21},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},

{2,  {0xE6,0x02},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},
{2,  {0xE7,0x0C},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},


{2,  {0x11,0x00},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},

{120, {0}, MIPI_DSI_DISPLAY_CONFIG_DATA_DELAY_FLAG, (mipi_dsi_cmd_flag_t)0},  // 120ms

{2,  {0xE0,0x00},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},

{2,  {0x29,0x00},                         MIPI_DSI_CMD_ID_DCS_SHORT_WRITE_1_PARAM,       MIPI_DSI_CMD_FLAG_LOW_POWER},

{5, {0}, MIPI_DSI_DISPLAY_CONFIG_DATA_DELAY_FLAG, (mipi_dsi_cmd_flag_t)0},  // 5ms
...
void mipi_dsi_push_table (const lcd_table_setting_t *table)
{
    ...
    while (MIPI_DSI_DISPLAY_CONFIG_DATA_END_OF_TABLE != p_entry->cmd_id)
    {
        ...
        else
        {
            ...
            handle_error(err, "** R_MIPI_DSI_Command API failed **\r\n");
            /* Wait */
...
void show_pattern(color_pattern_t pattern)
{
    ...
    switch(pattern){
        ...
        case partition:
            ...
            {
                for(uint32_t y=0;y<g_hz_size/2;y++)
                {
            ...
            for(uint32_t x=0;x<g_vr_size/2;x++)
            {
                for(uint32_t y=g_hz_size/2;y<g_hz_size;y++)
                {
...
void mipi_dsi_start_display(void)
{
    ...
    /* Handle error */
    handle_error(err, "** R_GPT_InfoGet API failed **\r\n");

    /* Start video mode */
    err = R_GLCDC_Start(&g_display_ctrl);
    /* Handle error */
    handle_error(err, "** R_GLCDC_Start API failed **\r\n");
...
static void mipi_dsi_ulps_enter(void)
{
    ...
    handle_error(err, "** R_MIPI_DSI_UlpsEnter API failed **\r\n");
...
static void mipi_dsi_ulps_exit(void)
{
    ...
    handle_error(err, "** R_MIPI_DSI_UlpsExit API failed **\r\n");
...
void touch_screen_reset(void)
{
     ...
     R_IOPORT_PinCfg(&g_ioport_ctrl, PIN_DISPLAY_INT, IOPORT_CFG_PORT_DIRECTION_INPUT\
                     | IOPORT_CFG_EVENT_RISING_EDGE | IOPORT_CFG_IRQ_ENABLE);
...
void handle_error (fsp_err_t err, const char * err_str)
{
    if(FSP_SUCCESS != err)
    {
        ...
        if(RESET_VALUE != g_display_ctrl.state)
        {
            ...
            {
                APP_ERR_PRINT("R_GLCDC_Close API failed\r\n");
            }
        }
 ...
 * @param[in]  period_time: Desired timer period in seconds.
 * @retval     None.
***********************************************************************************************************************/
static fsp_err_t timer_period_set(uint32_t period_time)
{
    ...
    APP_ERR_RETURN(err, " ** R_GPT_PeriodSet API failed **\r\n");

    err = R_GPT_Reset (&g_timer0_ctrl);
    APP_ERR_RETURN(err, " ** R_GPT_Reset API failed **\r\n");

    g_timer_overflow = RESET_FLAG;

    err = R_GPT_Start (&g_timer0_ctrl);
    APP_ERR_RETURN(err, " ** R_GPT_Start API failed **\r\n");
