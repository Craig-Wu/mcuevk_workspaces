**该示例工程由 李昌壕 提供，2026年6月17日**

### 工程概述

- 该示例工程演示了基于瑞萨 FSP ，在RA8T2 MCU CPU0 （Cortex-M85）驱动 SDRAM。
...
- 1 块 Renesas RA8 开发板：CPKCOR-RA8T2
- 1 根 USB Type A->Type C 或 Type-C->Type C 线（支持Type-C 2.0 即可）

### 硬件连接：

- 调试主机通过 USB Type-C 线连接 CPKCOR-RA8T2 板上的 USB 调试端口JDBG。
...
[sdram工程使用说明](sdram_cpkcor_ra8t2_ep_readme.adoc)
