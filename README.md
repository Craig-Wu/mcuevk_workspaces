...
瑞萨相关人员看到readme.md更新到完成状态后，会将该样例代码发布到[Github](https://github.com/renesas/cpk_examples)和[Gitee](about:blank)上的 CPK Examples，并<code style="color : red">**删除本代码仓库下的样例代码目录**</code> 。
