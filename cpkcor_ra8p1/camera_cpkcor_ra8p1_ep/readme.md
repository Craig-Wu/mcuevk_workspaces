**该示例工程由 李昌壕 提供，2026年7月14日**

### 工程概述

- 该示例工程演示了基于瑞萨 FSP ，在 RA8P1 MCU CPU0 （Cortex-M85）上同时驱动两个 OV5640 摄像头或者一个 OV5640 和一个 OV7725 摄像头。
...
- 1 个 OV7725 摄像头模组，两个 OV5640 摄像头模组
...
[Camera 测试工程使用说明](camera_cpkcor_ra8p1_ep_readme.adoc)
