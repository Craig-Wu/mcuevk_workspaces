...
- 该示例工程演示了基于瑞萨 FSP ，在RA8P1 MCU CPU0 （Cortex-M85）驱动 ILI9881C 屏幕显示彩条，使用 MIPI 接口。
...
- 1 个 ILI9881C 屏幕模块，分辨率 800x1280
...
[lcd_ili9881c_mipi工程使用说明](lcd_ili9881c_mipi_cpkhmi_ra8p1_ep_readme.adoc)
