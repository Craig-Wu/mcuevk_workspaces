...
#define CODE_ITCM           0x01
#define CODE_SRAM           0x02
#define CODE_SDRAM          0x03
#define CODE_OSPI0_CS0      0x04
#define CODE_OSPI0_CS1      0x05
#define CODE_OSPI1_CS0      0x06
#define CODE_OSPI1_CS1      0x07

#define DATA_SRAM           0x10
#define DATA_DTCM           0x11
#define DATA_SDRAM          0x12
#define DATA_OSPI0_CS0      0x13
#define DATA_OSPI0_CS1      0x14
#define DATA_OSPI1_CS0      0x15
#define DATA_OSPI1_CS1      0x16

#if __CODE_AREA == CODE_ITCM
...
#elif (__CODE_AREA == DATA_SRAM)        ||  \
      (__CODE_AREA == DATA_DTCM)        ||  \
      (__CODE_AREA == DATA_SDRAM)       ||  \
      (__CODE_AREA == DATA_OSPI0_CS0)   ||  \
      (__CODE_AREA == DATA_OSPI0_CS1)   ||  \
      (__CODE_AREA == CODE_OSPI1_CS0)   ||  \
      (__CODE_AREA == DATA_OSPI1_CS1)
...
#elif (__DATA_AREA == CODE_MRAM)        ||  \
      (__DATA_AREA == CODE_ITCM)        ||  \
      (__DATA_AREA == CODE_SRAM)        ||  \
      (__DATA_AREA == CODE_SDRAM)       ||  \
      (__DATA_AREA == CODE_OSPI0_CS0)   ||  \
      (__DATA_AREA == CODE_OSPI0_CS1)   ||  \
      (__DATA_AREA == CODE_OSPI1_CS0)   ||  \
      (__DATA_AREA == CODE_OSPI1_CS1)
