...
#define __ST7796U_DEBUG			0
#endif

#ifndef ST7796U_PIN_RESET
#define ST7796U_PIN_RESET		BSP_IO_PORT_00_PIN_13
#endif

#if __ST7796U_DEBUG
#include "utils/log.h"
#define UNLIKE_RETURN(v, t, msg, ...) if (v != t) { LOG_E(__FUNCTION__, msg, ##__VA_ARGS__); return; }
#else
#define UNLIKE_RETURN(v, t, msg, ...) if (v != t) { return; }
#endif
...
#define ST7796U_SPI_INSTANCE	g_sci_spi4
#define ST7796U_SPI_CALLBACK	SCI4_SPI_Callback
...
#define ST7796U_PIN_SPI_MISO	BSP_IO_PORT_07_PIN_15
#define ST7796U_PIN_SPI_CS      BSP_IO_PORT_05_PIN_15
#define ST7796U_PIN_DCX         BSP_IO_PORT_04_PIN_13
...
#if ST7796U_SPI_HARD_CS
    sci_b_spi_instance_ctrl_t *p_ctrl = (sci_b_spi_instance_ctrl_t *)ST7796U_SPI_INSTANCE.p_ctrl;
    p_ctrl->p_reg->CCR0_b.SSE = 1;
#endif
...
#error "Unimplemented interface"
    ...
    /* Don't know why doesn't the above statement work in RA8T2. */
    LCD_PortFillScreen(device, 0xFFFF);
